...
import { type Sound, showDateTime, showInterval } from "../../domain/base";
...
export const Hover = ({ sound, close$, play$, className }: Props) => {
  return (
    <div className={cn("shadow-md cursor-default pointer-events-auto", className)}>
      ...
      <div className="flex flex-col gap-2 p-4">
        <header>
          ...
          >
            ...
            <Icon name="Play" width={controlIconSize} height={controlIconSize} />
          </Button>
        </header>
        <div>
          {pipe(
